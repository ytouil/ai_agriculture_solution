...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result_file_path = '/opt/lampp/htdocs/websiteNasa/resultNASA_template.html';
    if (file_put_contents($result_file_path, $html_content) === false) {
        echo "Error: Failed to write resultNASA_template.html file.";
        exit();
    }

    echo "<a href='resultNASA_template.html'>View Results</a>";
} else {
